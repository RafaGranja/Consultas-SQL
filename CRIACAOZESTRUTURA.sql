...
CREATE TABLE ZATIVIDADES(
    ...
    RECMODIFIEDBY VARCHAR(50) COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL DEFAULT 'fluig',
    RECMODIFIEDON DATETIME NOT NULL DEFAULT GETDATE(),
	CONSTRAINT PK_IDATV PRIMARY KEY (OS,IDCRIACAO,CODATIVIDADE),
    CONSTRAINT FK_ITEMATV FOREIGN KEY (OS,IDCRIACAO) REFERENCES ZESTRUTURA (OS,IDCRIACAO),
...
CREATE TABLE ZCOMPONENTES(
    ...
    RECMODIFIEDBY VARCHAR(50) COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL DEFAULT 'fluig',
    RECMODIFIEDON DATETIME NOT NULL DEFAULT GETDATE(),
	CONSTRAINT PK_IDCOMP PRIMARY KEY (OS,IDCRIACAO,IDPRD),
    CONSTRAINT FK_ITEMCOMP FOREIGN KEY (OS,IDCRIACAO) REFERENCES ZESTRUTURA (OS,IDCRIACAO),
	CONSTRAINT FK_ATIVIDADE FOREIGN KEY (OS,IDCRIACAO,PRIORIDADE) REFERENCES ZATIVIDADES (OS,IDCRIACAO,PRIORIDADE),
