CREATE TABLE ZEXECUCAOTEMP(
	...
	CONSTRAINT PK_IDCRIACAOEXTEMP PRIMARY KEY ( OS,EXECUCAO,IDCRIACAO ),
	CONSTRAINT CK_TIPODESENHOEXTEMP CHECK (TIPODESENHO IN ('SEMIACABADO','ACABADO','NAOMANUFATURADO','INDUSTRIALIZACAO',NULL)),
	CONSTRAINT CK_UNDMEDIDAEXTEMP CHECK (UNDMEDIDA IN ('CJ','UN','PC',NULL)),
	CONSTRAINT CK_COMPORLISTAEXTEMP CHECK (COMPORLISTA IN ('SIM',NULL)),
	CONSTRAINT CK_OPSUNITARIASEXTEMP CHECK (OPSUNITARIAS IN ('SIM',NULL)),
	CONSTRAINT CK_CHECKUSINAGEMEXTEMP CHECK (CHECKUSINAGEM IN ('S','N',NULL)),
	CONSTRAINT CK_CHECKCALDERARIAEXTEMP CHECK (CHECKCALDERARIA IN ('S','N',NULL)),
	CONSTRAINT CK_QTDEUNCOMPEXTEMP CHECK (QTDEUNCOMP IN ('PESOUNITARIO','DESENHO',NULL)),
	CONSTRAINT CK_ITEMEXCLUSIVOEXTEMP CHECK (ITEMEXCLUSIVO IN (0,1,2)),
...
CREATE TABLE ZATIVIDADESEXTEMP(
	ID INT IDENTITY(1,1),
	OS VARCHAR(25) COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL,
    ...
    RECMODIFIEDBY VARCHAR(50) COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL DEFAULT 'fluig',
    RECMODIFIEDON DATETIME NOT NULL DEFAULT GETDATE(),
	CONSTRAINT PK_IDATVEXTEMP PRIMARY KEY (OS,EXECUCAO,IDCRIACAO,PRIORIDADE),
    CONSTRAINT FK_ITEMATVEXTEMP FOREIGN KEY (OS,EXECUCAO,IDCRIACAO) REFERENCES ZEXECUCAOTEMP (OS,EXECUCAO,IDCRIACAO),
...
CREATE TABLE ZCOMPONENTESEXTEMP(
	ID INT IDENTITY(1,1),
	OS VARCHAR(25) COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL,
	IDCRIACAO INT DEFAULT 1 NOT NULL,
	IDPRD INT NOT NULL,
    ...
    RECMODIFIEDBY VARCHAR(50) COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL DEFAULT 'fluig',
    RECMODIFIEDON DATETIME NOT NULL DEFAULT GETDATE(),
	CONSTRAINT PK_IDCOMPEXTEMP PRIMARY KEY (OS,EXECUCAO,IDCRIACAO,IDPRD),
    CONSTRAINT FK_ITEMCOMPEXTEMP FOREIGN KEY (OS,EXECUCAO,IDCRIACAO) REFERENCES ZEXECUCAOTEMP (OS,EXECUCAO,IDCRIACAO),
	CONSTRAINT FK_ATIVIDADEEXTEMP FOREIGN KEY (OS,EXECUCAO,IDCRIACAO,PRIORIDADE) REFERENCES ZATIVIDADESEXTEMP (OS,EXECUCAO,IDCRIACAO,PRIORIDADE),
	CONSTRAINT CK_CHECKLISTAEXTEMP CHECK (LISTA IN ('S','N',NULL)),
    INDEX ATV (OS,IDCRIACAO,EXECUCAO,PRIORIDADE),
