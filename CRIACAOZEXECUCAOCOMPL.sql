...
RECMODIFIEDON DATETIME NOT NULL DEFAULT GETDATE(),
CONSTRAINT PK_IDCRIACAOEXCOMPL PRIMARY KEY ( OS,CODORDEM ),
CONSTRAINT FK_IDCRIACAOEXCOMPL FOREIGN KEY ( OS,EXECUCAO,IDCRIACAO) REFERENCES Z_CRM_EX001005 (OS, IDCRIACAO, EXECUCAO),
)

CREATE INDEX IDCRIACAO2 ON Z_CRM_EX001005COMPL(OS,CODTRFPAI,EXECUCAO,IDCRIACAO)
CREATE INDEX IDCRIACAO ON Z_CRM_EX001005COMPL(OS,EXECUCAO,IDCRIACAO)
CREATE INDEX CODORDEM ON Z_CRM_EX001005COMPL(CODORDEM)
CREATE INDEX ORDEM ON Z_CRM_EX001005COMPL(OS,EXECUCAO,CODORDEM)
