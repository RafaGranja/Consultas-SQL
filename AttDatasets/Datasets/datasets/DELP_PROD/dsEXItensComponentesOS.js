...
function createDataset(fields, constraints, sortFields) {
	...
	var dsEXItensComponentesOS = DatasetBuilder.newDataset();
    ...
    log.info("QUERY dsEXItensComponentesOS: " + myQuery);
        ...
        while (rs.next()) {
            ...
            if (!created) {
                ...
                for (var i = 1; i <= columnCount; i++) {
                	...
                	dsEXItensComponentesOS.addColumn(rs.getMetaData().getColumnName(i));
            ...
            dsEXItensComponentesOS.addRow(Arr);
